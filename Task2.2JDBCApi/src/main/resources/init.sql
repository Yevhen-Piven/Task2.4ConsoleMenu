...
CREATE TABLE school.students (student_id int primary key, group_id int  references school.student_groups(group_id), first_name character varying(250) not null, last_name character varying(250) not null,active BOOLEAN );
CREATE TABLE school.courses (course_id int primary key, course_name character varying(250) not null, course_description character varying(250), interval INTERVAL);
